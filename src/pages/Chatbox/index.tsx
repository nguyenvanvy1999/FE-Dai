...
function UserChat({ active = false }: IUserChat) {
  return (
    <div
      className={`block md:flex items-center p-4 justify-between cursor-pointer ${
        active && 'bg-gray-200'
      } hover:bg-gray-100`}
    >
      <img
    ...
    <div className={`flex mb-5 ${left ? 'pr-5 lg:pr-60' : 'pl-5 lg:pl-60'}`}>
      ...
      <div className="text-sm w-full">
        <p className="bg-gray-200 p-2 rounded-md">
          Chào mừng bạn đến với taphoammo. Nếu có khó khăn gì trong quá trình sử dụng trang, nhắn
          tin cho mình ngay nhé. Bạn có thể tham khảo thêm về các câu hỏi thường gặp trên menu chính
          (FAQs). Xin cảm ơn.
        </p>
      ...
      <div className={`box border border-gray-300 rounded-lg grid grid-cols-5`}>
        {isExpand && (
          <div className="col-span-2">
            <div className="border-b border-gray-300 flex justify-between items-center py-3 px-5">
              ...
              <div>
                <button
                  className="bg-gray-200 p-2 px-5 rounded-lg text-blue-400"
        ...
        <div className={`border-l border-gray-300 ${isExpand ? 'col-span-3' : 'col-span-5'}`}>
          <div className="bg-gray-200 text-center py-2 relative">
            {!isExpand && (
              <button
                className="bg-gray-300 p-0.5 px-1 md:p-2 md:px-5 rounded-lg text-blue-400 absolute left-3 top-1 md:left-5 md:top-3"
            ...
            <div className="flex items-center justify-center">
              ...
              <span className="text-gray-500 text-min ml-3">Online 10 giờ trước.</span>
            </div>
            <div>
