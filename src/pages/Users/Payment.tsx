  ...
  return (
    <MainLayout>
        ...
        <ul className="flex flex-wrap -mb-px text-sm font-medium text-center" id="myTab" data-tabs-toggle="#myTabContent" role="tablist">
          <li className="" role="presentation">
            <button onClick={() => setActiveTab(tabs.payment)}
              className={`${activeTab === tabs.payment ? "border-t border-x" : "border-b"} bg-white inline-block p-4 rounded-t-lg hover:text-gray-600 hover:border-gray-300`}
          ...
          <li className="" role="presentation">
            <button onClick={() => setActiveTab(tabs.exchange)}
              className={`${activeTab === tabs.exchange ? "border-t border-x" : "border-b"} bg-white inline-block p-4 rounded-t-lg hover:text-gray-600 hover:border-gray-300`}
      ...
      {activeTab === tabs.payment &&
        <div id="myTabContent" className="-mt-0.5 border border-gray-200 -z-10">
          <div>
            ...
            <div className="flex px-2 lg:px-10 py-5 items-center justify-between rounded-lg mt-2">
        ...
        <div id="myTabContent" className="-mt-0.5 border border-gray-200 -z-10">
          <div>
            <div className="flex px-10 py-5 items-center justify-between rounded-lg">
              ...
              <div>
                <Button variant="primary" onClick={() => { setOpenModal(true) }}>Tạo yêu cầu rút tiền</Button>
              </div>
            </div>
            <div className="flex px-2 lg:px-10 py-5 items-center justify-between rounded-lg mt-2">
              <div className="relative overflow-x-auto p-5">
      ...
      <ExchangeModal openModal={openModal} setOpenModal={setOpenModal} />
    </MainLayout>
  )
}
