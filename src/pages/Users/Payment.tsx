        ...
        >
          <li className="" role="presentation">
            <button
              ...
              className={`${
                activeTab === tabs.payment ? 'border-t border-x' : 'border-b'
              } bg-white inline-block p-4 rounded-t-lg hover:text-gray-600 hover:border-gray-300`}
              id="profile-tab"
          ...
          <li className="" role="presentation">
            <button
              ...
              className={`${
                activeTab === tabs.exchange ? 'border-t border-x' : 'border-b'
              } bg-white inline-block p-4 rounded-t-lg hover:text-gray-600 hover:border-gray-300`}
              id="dashboard-tab"
