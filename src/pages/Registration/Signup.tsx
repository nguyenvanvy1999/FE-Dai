...
function Signup() {
  const { handleRegister, isLoadingRegister } = useAuth()
  const {
    handleSubmit,
    control,
    formState: { errors },
  ...
  return (
    <form
      className="container col-span-1 md:col-span-2 border-solid border rounded-lg border-gray-200 p-5"
    ...
    >
      <div>
        ...
        <p className="text-green-600 mt-5">
          ...
          <span className="text-red-500">Bypass Captcha</span> có thể không đăng ký tài khoản được.
        </p>
        ...
        <Button
          variant="primary"
          className="w-32 mt-14 text-center"
          type="submit"
