                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 mt-5 gap-5">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 col-span-1 md:col-span-2 gap-5">
                        <div>
                            ...
                            <div className="text-gray-900 mt-3 font-semibold">Quy trình nuôi 1 ac cho người mới</div>
                            <p className="mt-2">Quy trình nuôi 1 ac cho người mới B1. Mua ac tittok 1000fl để mở tiktok shop Trên tamhoamomo B2. Đăng ký 4g tắt bật 4g rồi mới đăng nhập tk vào app multiple -Điền đầy đủ thông tin tài khoản tên tk ,id...</p>
                            <div className="flex mt-2">
                                <div className="flex items-center"><AiOutlineEye /><span className="ml-1">932</span></div>
                                <div className="flex items-center ml-3"><AiOutlineLike /><span className="ml-1">1</span></div>
                                <div className="flex items-center ml-3" ><FaRegComments /><span className="ml-1">0</span></div>
                            </div>
                        </div>
                        <div>
                            <Image custom={{ height: '220px' }} />
