  ...
  return (
    <MainLayout>
      <form
        ...
        className="container mx-auto px-4 md:px-10 border border-gray-300 rounded-lg py-5 my-10"
      >
        ...
        <div className="mt-5">
          <label className="block mb-2 text-sm font-semibold text-gray-900" htmlFor="default_size">
        ...
        <div className="flex mt-20">
          <Button
            variant="secondary"
            className="w-32 g:w-32 border border-solid border-green-500 text-center"
          >
            <span className="text-gray-900">Quay lại</span>
          </Button>
          <Button
            variant="primary"
            className="w-32 g:w-32 ml-4 lg:ml-8 border border-solid border-green-500 text-center"
            type="submit"
          >
        ...
        <div>
          ...
          <ul className="text-green-600 list-disc ml-10">
            <li>
              Những nội dung được duyệt chỉ gói gọn trong các chia sẻ về "nghề" MMO, kiến thức, kinh
              nghiệm, trải nghiệm về mọi mảng trong cách kiếm tiền online!
            </li>
            <li>Các nội dung về chính trị, tôn giáo, kích động... sẽ không được duyệt!</li>
            <li>
              Không đăng các bài viết quảng cáo, tuyển ref, giới thiệu dự án, lùa gà... (không cần
              biết dự án có lừa đảo hay không)
            </li>
            <li>
              Không đăng nội dung vi phạm quyền sở hữu trí tuệ của người khác, bao gồm vi phạm nhãn
              hiệu hàng hóa và bản quyền.
            </li>
            <li>
              Những bài viết chất lượng sẽ được lựa chọn để làm điểm tuần và nhận thưởng từ sàn.
            </li>
