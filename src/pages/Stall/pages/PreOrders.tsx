    ...
    <StallLayout>
      <div className="m-4 max-w-full bg-slate-50 inline-block pl-2">
        ...
        <span className="text-red-500">
          * Thời gian hoàn thành đơn hàng tính bằng ngày, trong thời gian đó, nếu kho hàng đủ số
          lượng thì đơn hàng sẽ tự động hoàn thành. Ngược lại đơn sẽ tự hủy và hoàn tiền cho khách.
        </span>
