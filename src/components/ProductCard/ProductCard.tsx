...
export default function ProductCard({ className }: ProductCardProps) {
  return (
    <div className={`flex gap-3 p-4 border ${className}`}>
      <div className="relative">
        ...
        <div className="mt-3 text-black-light text-center text-15px font-bold">3.100đ - 7.000đ</div>
      ...
      <div className="flex flex-col gap-2">
        <Link to="" className="flex gap-2 text-16px font-medium hover:text-green-300">
          <Badge variant="success">Sản phẩm</Badge>
